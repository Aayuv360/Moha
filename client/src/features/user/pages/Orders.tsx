              ...
              <div className="space-y-4">
                {userReturns.map((returnRecord) => {
                  ...
                  return (
                    <Card
                      key={returnRecord.id}
                      data-testid={`return-card-${returnRecord.id}`}
                    >
                      <CardHeader>
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          <div>
                          ...
                          <Badge
                            className={
                              returnStatusColors[returnRecord.status] ||
                              returnStatusColors.requested
                            }
                          >
                          ...
                          {returnRecord.status === "rejected" && (
                            <div className="bg-red-50 dark:bg-red-950 p-3 rounded">
                              <p className="text-sm text-red-800 dark:text-red-100">
                                Your return request has been rejected. Contact
                ...
                <Button
                  onClick={() => {
                    if (!returnReason.trim()) {
                      toast({
                        title: "Please provide a reason for return",
                        variant: "destructive",
                      });
                      return;
                    }
                    createReturnMutation.mutate({
                      ...
                      reason: returnReason,
                      refundAmount: (
                        selectedReturn.price * returnQuantity
                      ).toString(),
                      inventoryId: orders.find(
                        (o) => o.id === selectedReturn.orderId,
                      )?.inventoryId,
                    });
                  }}
